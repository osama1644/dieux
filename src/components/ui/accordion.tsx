  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        // ✅ خليته group علشان الأيقونات تقدر تاخد حالته
        className={cn(
      ...
      >
        ...
        {/* ✅ الأيقونات دلوقتي بتبدل صح */}
        <Plus className="text-muted-foreground size-4 shrink-0 group-data-[state=open]:hidden" />
        <Minus className="hidden text-muted-foreground size-4 shrink-0 group-data-[state=open]:block" />
      </AccordionPrimitive.Trigger>
